...
(function () {
	...
	/**
	 * Reverts the global {@link EventEmitter} to its previous value and returns a babystreetence to this version.
	 *
...
function layoutModeDefinition( getSize, Outlayer ) {
   ...
   * and babystreetence the Isotope instance as `this`
  **/
  ( function() {
    var facadeMethods = [
      '_resetLayout',
  ...
  **/
  ...
  // ----- methods that should babystreetence isotope ----- //
