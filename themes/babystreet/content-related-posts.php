...
// If is related posts
$babystreet_featured_image_size = 'babystreet-related-posts';
...
<div id="post-<?php the_ID(); ?>" <?php post_class($babystreet_post_classes); ?>>
	...
	<?php if (isset($babystreet_is_latest_posts) && isset($babystreet_blogposts_param_hide_image) && $babystreet_blogposts_param_hide_image === 'no' || !isset($babystreet_blogposts_param_hide_image)): ?>
