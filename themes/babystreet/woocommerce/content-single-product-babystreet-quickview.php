...
<div itemscope itemtype="<?php echo esc_url('http://schema.org/' . $schema); ?>" id="product-<?php the_ID(); ?>" <?php post_class('box box-common fixed babystreet-single-product'); ?>>
	...
	?>
	<div class="babystreet-quickview-images images <?php if (count($attachment_ids)): ?>owl-carousel babystreet-owl-carousel<?php endif; ?>">
		...
		if (has_post_thumbnail()) {
			...
			echo apply_filters('woocommerce_single_product_image_html', sprintf('<img src="%s" alt="%s" />', wc_placeholder_img_src(), esc_html__('Placeholder', 'babystreet')), $product->get_id());
		}
		?>
	</div>
