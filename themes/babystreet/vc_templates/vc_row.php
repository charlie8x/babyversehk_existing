 ...
 */
$el_class = $full_height = $parallax_speed_bg = $parallax_speed_video = $full_width = $equal_height = $flex_row = $columns_placement = $content_placement = $parallax = $parallax_image = $css = $el_id = $video_bg = $video_bg_url = $video_bg_parallax = $css_animation = $weaves_effect = '';
$disable_element = '';
$after_output = '';
...
if (!empty($el_id)) {
	...
	$wrapper_attributes[] = 'id="' . esc_attr('babystreet_' . $unique_id) . '"';
	$row_id = 'babystreet_' . $unique_id;
}
if (!empty($full_width)) {
...
if (!empty($allow_overflow) && $allow_overflow == 'yes') {
	$css_classes[] = 'babystreet-visible-overlay';
}
if (!empty($fixed_background) && $fixed_background == 'yes') {
	$css_classes[] = 'babystreet-fixed-background';
}
if (!empty($weaves_effect) && $weaves_effect == 'yes') {
	$css_classes[] = 'babystreet-waveRow';
}
...
<div <?php echo implode( ' ', $wrapper_attributes ) ?>>
	...
	<?php if(!empty($weaves_effect) && $weaves_effect === 'yes'): ?>
