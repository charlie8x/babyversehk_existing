...
add_filter( 'woocommerce_price_filter_widget_step', 'babystreet_set_price_filter_widget_step' );
if ( ! function_exists( 'babystreet_set_price_filter_widget_step' ) ) {
	function babystreet_set_price_filter_widget_step() {
		return babystreet_get_option( 'price_filter_widget_step' );
	}
}
		...
		echo '<form id="babystreet-price-filter-form" data-currency_pos="' . esc_attr(get_option('woocommerce_currency_pos')) . '" data-currency_symbol="' . esc_attr(get_woocommerce_currency_symbol()) . '"  method="get" action="' . esc_url($form_action) . '">
									<div id="price-filter" class="price_slider_wrapper">
										<div class="price_slider_amount" data-step="' . esc_attr( $step ) . '">
												<input type="hidden" id="min_price" name="min_price" value="' . esc_attr($current_min_price) . '" data-min="' . esc_attr($min_price) . '" placeholder="' . esc_attr__('Min price', 'babystreet') . '" />
												<input type="hidden" id="max_price" name="max_price" value="' . esc_attr($current_max_price) . '" data-max="' . esc_attr($max_price) . '" placeholder="' . esc_attr__('Max price', 'babystreet') . '" />
