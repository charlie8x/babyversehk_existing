...
function babystreet_optionsframework_options() {
	...
	$options[] = array(
			...
			'id' => 'copyright_text',
			'std' => 'Babystreet theme by <a target="_blank" title="theAlThemist\'s portfolio" href="http://themeforest.net/user/theAlThemist/portfolio?ref=theAlThemist">theAlThemist</a> | &#169; 2020 All rights reserved!',
			'type' => 'textarea'
	);
	...
	$options[] = array(
			...
			'desc' => esc_html_x('Choose font parameters for the body text.', 'theme-options', 'babystreet') . '<br>' .
			          '<b>' . esc_html_x('Note', 'babystreet') . ': </b>' . esc_html_x('Choose -- None -- to use custom font, not managed by Babystreet. Preview will be disabled.', 'babystreet'),
			'id' => 'body_font',
	...
	$options[] = array(
			...
			'desc' => esc_html_x('Choose Font Face.', 'theme-options', 'babystreet') . '<br>' .
			          '<b>' . esc_html_x('Note', 'babystreet') . ': </b>' . esc_html_x('Choose -- None -- to use custom font, not managed by Babystreet. Preview will be disabled.', 'babystreet'),
			'id' => 'headings_font',
	...
	if (defined('BABYSTREET_IS_WOOCOMMERCE') && BABYSTREET_IS_WOOCOMMERCE) {
		...
		$options[] = array(
			'name' => esc_html_x('Price Filter Slider Step', 'theme-options', 'babystreet'),
			'desc' => esc_html_x('Set the step at which the slider changes and rounds min and max price boundaries.', 'theme-options', 'babystreet'),
