jQuery(document).ready(function () {
	"use strict";
	var google_fonts_defined_json = babystreet_font_prev_params.fonts.replace(/&quot;/g, '"');
	...
	jQuery('#body_font_size,#body_font_face').change(function () {
		if (!google_fonts_defined.hasOwnProperty(jQuery('#body_font_face').val())) {
			jQuery("[id^='babystreet_ogfB_']").remove();
			jQuery('head').append('<link id="babystreet_ogfB_' + jQuery('#body_font_face').val() + '" rel="stylesheet" href="//fonts.googleapis.com/css?family=' + jQuery('#body_font_face').val() + ':100,100italic,200,200italic,300,300italic,400,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic&subset=' + babystreet_font_prev_params.google_subset + '">@font-face {font-family: "' + jQuery('#body_font_face option:selected').text() + '";}</link>');
		}
	...
	jQuery('#headings_font_face').change(function () {
		if (!google_fonts_defined.hasOwnProperty(jQuery('#headings_font_face').val())) {
			jQuery("[id^='babystreet_ogfH_']").remove();
			jQuery('head').append('<link id="babystreet_ogfH_' + jQuery('#headings_font_face').val() + '" rel="stylesheet" href="//fonts.googleapis.com/css?family=' + jQuery('#headings_font_face').val() + ':100,100italic,200,200italic,300,300italic,400,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic&subset=' + babystreet_font_prev_params.google_subset + '">@font-face {font-family: "' + jQuery('#headings_font_face option:selected').text() + '";}</link>');
		}
