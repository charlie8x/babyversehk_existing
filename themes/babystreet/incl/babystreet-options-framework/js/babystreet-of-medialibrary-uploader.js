...
(function ($) {
    ...
    babystreet_optionsframeworkMLU = {
        ...
        mediaUpload: function () {
            ...
            var formfield,
                ...
                tbframe_interval;
            // On Click
            $('input.babystreet_upload_button').on("click", function (e) {
    ...
    }; // End babystreet_optionsframeworkMLU Object // Don't remove this, or the sky will fall on your head.

    /*-----------------------------------------------------------------------------------*/
    /* Execute the above methods in the babystreet_optionsframeworkMLU object.
     /*-----------------------------------------------------------------------------------*/

    $(document).ready(function () {

        babystreet_optionsframeworkMLU.removeFile();
        babystreet_optionsframeworkMLU.recreateFileField();
        babystreet_optionsframeworkMLU.mediaUpload();
