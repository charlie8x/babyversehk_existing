...
<ul class="zoo-extend-cart-info">
	<?php
	if(get_theme_mod('zoo_single_product_cart_size_guide','0')!='0'&&get_theme_mod('zoo_single_product_cart_size_guide','0')!=''){
	...
	if(get_theme_mod('zoo_single_product_cart_delivery','0')!='0'&&get_theme_mod('zoo_single_product_cart_delivery','0')!=''){
	...
	if(get_theme_mod('zoo_single_product_cart_ask_product','0')!='0'&&get_theme_mod('zoo_single_product_cart_ask_product','0')!=''){
