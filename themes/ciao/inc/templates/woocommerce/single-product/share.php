        ...
        <ul class="social-icons">
            <li class="facebook"><a href="http://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>"
                          ...
                          '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=220,width=600');return false;"
                                    title="<?php echo esc_attr__('Share to facebook', 'ciao') ?>"><i
            ...
            <li class="pinterest"><a
                        ...
                        title="<?php echo esc_attr__('Share to pinterest', 'ciao') ?>"><i
                            class="cs-font clever-icon-pinterest"></i></a></li>
            <li class="mail"><a
                        href="mailto:?subject=<?php the_title_attribute(); ?>&body=<?php echo strip_tags(get_the_excerpt()); ?> <?php the_permalink(); ?>"
                        class="product_share_email icon-around"
                        title="<?php echo esc_attr__('Sent to mail', 'ciao') ?>"><i class="cs-font clever-icon-email-envelope"></i></a>
            </li>
        </ul>
</div><?php }