...
if ( get_theme_mod( 'zoo_enable_blog_related', '1' ) == 1 ) {
	...
	if ( $zoo_related_query->have_posts() ) {
        ...
        <section class="post-related wrap-loop-content grid-layout col-12 col-xl-8">
            <h3 class="title-block"><?php esc_html_e( 'You may also like', 'ciao' ); ?></h3>
            <div class="row">
                    ...
                    <article <?php echo post_class( $class ) ?>>
                        <div class="zoo-post-inner">
                            ...
                            <div class="wrap-post-item-content">
								<?php
								the_title( sprintf( '<h3 class="entry-title title-post"><a href="%s" rel="' . esc_attr__( 'bookmark', 'ciao' ) . '">', esc_url( get_permalink() ) ), '</a></h3>' );
