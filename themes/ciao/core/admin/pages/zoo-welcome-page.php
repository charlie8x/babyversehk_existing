...
final class Zoo_Welcome_Page
{
    ...
    {
        $label = !empty($this->theme->name) ? $this->theme->name : esc_html__('Welcome', 'ciao');
            ...
            <div id="zoo-welcome-panel" class="zoo-welcome-panel">
                <div class="zoo-welcome-panel-content">
                    <div class="zoo-welcome-heading">
                    	<h1><?php printf(esc_html__( 'Welcome to %s', 'ciao' ), $this->theme->name); ?></h1>
                    	<p><?php printf(esc_html__( 'Thank you for choosing %s! Get ready to build something beautiful. Please register your purchase to get automatic theme updates, import sample data and install premium plugins. Check out theme documentation and our support center to learn how to receive product support and how to make awesome things with this theme. We hope you enjoy it!', 'ciao'), $this->theme->name); ?></p>
                    </div>
            ...
            <div class="dashboard-widgets-wrap">
                <div id="dashboard-widgets" class="metabox-holder">
                    <table class="system-status widefat" cellspacing="0">
                    	<thead>
                    		<tr>
                    			<th colspan="3"><?php esc_html_e('System Status', 'ciao') ?></th>
                    		</tr>
                    	</thead>
                    	<tbody>
                            <tr>
