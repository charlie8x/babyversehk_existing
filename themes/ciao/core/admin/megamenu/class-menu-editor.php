...
final class Zoo_Mega_Menu_Edit
{
		...
		<div id="zoo-settings" tabindex="0" class="zoo-settings">
			<div class="zoo-modal media-modal wp-core-ui">
				<button type="button" class="button-link media-modal-close zoo-modal-close">
					<span class="media-modal-icon"><span class="screen-reader-text"><?php esc_html_e('Close', 'ciao') ?></span></span>
				</button>
					...
					<div class="zoo-frame-toolbar media-frame-toolbar">
						<div class="zoo-toolbar media-toolbar">
							<div class="zoo-toolbar-primary media-toolbar-primary search-form">
								<button type="button" class="button zoo-button zoo-button-save media-button button-primary button-large"><?php esc_html_e('Save Changes', 'ciao') ?></button>
								<button type="button" class="button zoo-button zoo-button-cancel media-button button-secondary button-large"><?php esc_html_e('Cancel', 'ciao') ?></button>
								<span class="spinner"></span>
							</div>
						</div>
					</div>
    ...
    public function templates()
    {
        ...
        <script type="text/template" id="zoo-tmpl-menus">
            <% if ( depth == 0 ) { %>
            <a href="#" class="media-menu-item active" data-title="<?php esc_attr_e('Mega Menu Content', 'ciao' ) ?>" data-panel="mega"><?php esc_html_e('Mega Menu', 'ciao' ) ?></a>
            <a href="#" class="media-menu-item" data-title="<?php esc_attr_e('Mega Menu Background', 'ciao' ) ?>" data-panel="background"><?php esc_html_e('Background', 'ciao' ) ?></a>
            <div class="separator"></div>
            <% } else if ( depth >= 1 ) { %>
            <a href="#" class="media-menu-item active" data-title="<?php esc_attr_e('Menu Content', 'ciao' ) ?>" data-panel="content"><?php esc_html_e('Menu Content', 'ciao' ) ?></a>
            <% } %>
        </script>
                ...
                <div class="wrap-head-panel-mega">
                    <p class="zoo-panel-box">
                        <label>
                            ...
                            <?php esc_html_e('Enable Mega Menu', 'ciao') ?>
                        </label>
                    </p>
                    <p class="zoo-panel-box-large">
                        <label>
                            <?php esc_html_e('Mega Menu Width', 'ciao') ?>
            		...
            		<p>
            			<label>
            				...
            				<?php esc_html_e( 'Trending label', 'ciao' ) ?>
            			</label>
            		</p>
                </div>
        ...
        <script type="text/template" id="zoo-tmpl-background">
            ...
            <div id="zoo-panel-background" class="zoo-panel-background zoo-panel">
                <div class="background-image">
                    <label><?php esc_html_e('Background Image', 'ciao') ?></label><br>
                    ...
                    <button type="button"
                            class="button remove-button <% if ( ! megaData.background.image ) { print( 'hidden' ) } %>"><?php esc_html_e('Remove', 'ciao') ?></button>
                    <button type="button" class="button upload-button"
                            id="background_image-button"><?php esc_html_e('Select Image', 'ciao') ?></button>
                ...
                <div class="wrap-background-extend-options">
                    <p class="background-color">
                        <label><?php esc_html_e('Background Color', 'ciao') ?></label><br>
                    ...
                    <p class="background-repeat">
                        <label><?php esc_html_e('Background Repeat', 'ciao') ?></label><br>
                    ...
                    <p class="background-attachment">
                        <label><?php esc_html_e('Background Attachment', 'ciao') ?></label><br>
                        <select name="<%= zooMegaMenu.getFieldName( 'background.attachment', itemId ) %>">
                            ...
                            %>><?php esc_html_e('Scroll', 'ciao') ?></option>
                            <option value="fixed"
                            <% if ( 'fixed' == megaData.background.attachment ) { print( 'selected="selected"' ) }
                            %>><?php esc_html_e('Fixed', 'ciao') ?></option>
                        </select>
                    </p>
                </div>
            </div>
		...
		<script type="text/template" id="zoo-tmpl-content">
            ...
            <div id="zoo-panel-content" class="zoo-panel-content zoo-panel">
                ...
                <p class="content-image">
            		<label><?php esc_html_e( 'Image', 'ciao' ) ?></label><br>
                    ...
                    <br>
            		<button type="button" class="button remove-button <% if ( ! megaData.contentImage ) { print( 'hidden' ) } %>"><?php esc_html_e( 'Remove', 'ciao' ) ?></button>
            		<button type="button" class="button upload-button" id="content_image-button"><?php esc_html_e( 'Select Image', 'ciao' ) ?></button>
            	...
            	<p class="description"><?php esc_html_e( 'Allow HTML and Shortcodes', 'ciao' ) ?></p>
            </div>
		</script>
		<?php
    }
