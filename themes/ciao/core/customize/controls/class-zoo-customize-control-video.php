<?php
/**
 * Zoo_Customize_Control_Video
 *
 * @package  Zoo_Theme\Core\Customize\Classes\Controls
 *
 */
final class Zoo_Customize_Control_Video extends Zoo_Customize_Control_Media
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-zoo-customize-control-video">
        <#
        var required = '';
