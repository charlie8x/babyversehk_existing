            ...
            if ($this->setting_type != 'custom_html') {
                ...
                if ($this->setting_type == 'repeater') {
                    ?><div class="zoo-repeater-actions">
                        <a href="#" class="zoo-repeater-reorder" data-text="<?php esc_attr_e('Reorder', 'ciao'); ?>" data-done="<?php esc_attr_e('Done', 'ciao'); ?>"><?php _e('Reorder', 'ciao'); ?></a>
                        <?php if ($this->addable !== false) { ?>
                            <button type="button" class="button zoo-repeater-add-new"><?php esc_html_e('Add an item', 'ciao'); ?></button><?php
                        }
                    ?></div><?php
                }
            }
