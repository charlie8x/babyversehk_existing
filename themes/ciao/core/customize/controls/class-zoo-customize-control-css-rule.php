...
final class Zoo_Customize_Control_CSS_Rule extends Zoo_Customize_Control_Default
{
    ...
    static function control_template()
    {
        ...
        <div class="zoo-customize-control zoo-customize-control-{{ data.type }} {{ data.class }} zoo-customize-control-name-{{ data.original_name }}" data-required="{{ required }}" data-field-name="{{ data.name }}">
            ...
            var defaultpl = <?php echo json_encode(__('Auto', 'ciao')); ?>;
            ...
            <div class="zoo-customize-control-settings-inner">
                <div class="zoo-css-ruler zoo-gr-inputs">
                    <span>
                        ...
                        <span class="zoo-small-label"><?php esc_html_e('Top', 'ciao'); ?></span>
                    </span>
                    <span>
                        ...
                        <span class="zoo-small-label"><?php esc_html_e('Right', 'ciao'); ?></span>
                    </span>
                    <span>
                        ...
                        <span class="zoo-small-label"><?php esc_html_e('Bottom', 'ciao'); ?></span>
                    </span>
                    <span>
                        ...
                        <span class="zoo-small-label"><?php esc_html_e('Left', 'ciao'); ?></span>
                    </span>
                    <label title="<?php esc_attr_e('Toggle values together', 'ciao'); ?>" class="zoo-css-ruler-link <# if (data.value.link == 1){ #> zoo-label-active <# } #>">
