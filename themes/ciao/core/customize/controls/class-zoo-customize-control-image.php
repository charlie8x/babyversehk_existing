<?php
/**
 * Zoo_Customize_Control_Image
 *
 * @package  Zoo_Theme\Core\Customize\Classes\Controls
 *
 */
class Zoo_Customize_Control_Image extends Zoo_Customize_Control_Media
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-zoo-customize-control-image">
        <#
        var required = '';
        ...
        <div class="zoo-customize-control zoo-customize-control-{{ data.type }} {{ data.class }} zoo-customize-control-name-{{ data.original_name }}" data-required="{{ required }}" data-field-name="{{ data.name }}">
            ...
            <div class="zoo-customize-control-settings-inner zoo-media-type-{{ data.type }}">
                <div class="zoo-media">
                    ...
                    <button type="button" class="button zoo-add <# if ( url ) { #> zoo-hide <# } #>"><?php esc_html_e( 'Select', 'ciao' ); ?></button>
