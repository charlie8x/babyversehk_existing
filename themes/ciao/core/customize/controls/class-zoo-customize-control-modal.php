<?php
/**
 * Zoo_Customize_Control_Modal
 *
 * @package  Zoo_Theme\Core\Customize\Classes\Controls
 *
 */
class Zoo_Customize_Control_Modal extends Zoo_Customize_Control_Default
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-zoo-customize-control-modal">
        <#
        var required = '';
        ...
        <div class="zoo-customize-control zoo-customize-control-{{ data.type }} {{ data.class }} zoo-customize-control-name-{{ data.original_name }}" data-required="{{ required }}" data-field-name="{{ data.name }}">
            ...
            <div class="zoo-actions">
                <a href="#" title="<?php esc_attr_e( 'Reset to default', 'ciao' ); ?>" class="action--reset" data-control="{{ data.name }}"><span class="dashicons dashicons-image-rotate"></span></a>
                <a href="#" title="<?php esc_attr_e( 'Toggle edit panel', 'ciao' ); ?>" class="action--edit" data-control="{{ data.name }}"><span class="dashicons dashicons-edit"></span></a>
            </div>
