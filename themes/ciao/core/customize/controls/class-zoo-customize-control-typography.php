    ...
    static function control_template()
    {
        ...
        <div class="zoo-customize-control zoo-customize-control-{{ data.type }} {{ data.class }} zoo-customize-control-name-{{ data.original_name }}" data-required="{{ required }}" data-field-name="{{ data.name }}">
            ...
            <div class="zoo-actions">
                <a href="#" class="action--reset" data-control="{{ data.name }}" title="<?php esc_attr_e( 'Reset to default', 'ciao' ); ?>"><span class="dashicons dashicons-image-rotate"></span></a>
                <a href="#" class="action--edit" data-control="{{ data.name }}" title="<?php esc_attr_e( 'Toggle edit panel', 'ciao' ); ?>"><span class="dashicons dashicons-edit"></span></a>
            </div>
