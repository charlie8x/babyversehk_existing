       ...
       <script type="text/html" id="tmpl-zoo-customize-control-icon">
        ...
        <div class="zoo-customize-control-settings-inner">
            <div class="zoo-icon-picker">
                ...
                <input type="text" readonly class="zoo-input zoo-pick-icon zoo-input-icon-name" placeholder="<?php esc_attr_e( 'Pick an icon', 'ciao' ); ?>" data-name="{{ data.name }}" value="{{ data.value.icon }}">
                <span class="zoo-icon-remove" title="<?php esc_attr_e( 'Remove', 'ciao' ); ?>">
                    <span class="dashicons dashicons-no-alt"></span>
                    <span class="screen-reader-text">
                    <?php esc_html_e( 'Remove', 'ciao' ) ?></span>
                </span>
            </div>
        </div>
        </div>
        ...
        <div id="zoo-sidebar-icons">
            <div class="zoo-sidebar-header">
                <a class="customize-controls-icon-close" href="#">
                    <span class="screen-reader-text"><?php esc_html_e( 'Cancel', 'ciao' );  ?></span>
                </a>
                <div class="zoo-icon-type-inner">
                    <select id="zoo-sidebar-icon-type">
                        <option value="all"><?php esc_html_e( 'All Icon Types', 'ciao' ); ?></option>
                    </select>
                </div>
            </div>
            <div class="zoo-sidebar-search">
               <input type="text" id="zoo-icon-search" placeholder="<?php esc_attr_e( 'Type icon name', 'ciao' ) ?>">
            </div>
