        ...
        <script type="text/html" id="tmpl-customize-control-repeater-item">
            <div class="zoo-repeater-item">
                <div class="zoo-repeater-item-heading">
                    <label class="zoo-repeater-visible" title="<?php esc_attr_e( 'Toggle item visible', 'ciao' ); ?>"><input type="checkbox" class="r-visible-input"><span class="r-visible-icon"></span><span class="screen-reader-text"><?php _e( 'Show', 'ciao' ) ?></label>
                    <span class="zoo-repeater-live-title"></span>
                    <div class="zoo-nav-reorder">
                        <span class="zoo-down" tabindex="-1"><span class="screen-reader-text"><?php esc_html_e( 'Move Down', 'ciao' ) ?></span></span>
                        <span class="zoo-up" tabindex="0"><span class="screen-reader-text"><?php esc_html_e( 'Move Up', 'ciao' ) ?></span></span>
                    </div>
                    <a href="#" class="zoo-repeater-item-toggle"><span class="screen-reader-text"><?php esc_html_e( 'Close', 'ciao' ) ?></span></a>
                </div>
                <div class="zoo-repeater-item-settings">
                    <div class="zoo-repeater-item-inside">
                        <div class="zoo-repeater-item-inner"></div>
                        <# if ( data.addable ){  #>
                            <a href="#" class="zoo-remove"><?php esc_html_e( 'Remove', 'ciao' ); ?></a>
                            <# } #>
                    </div>
                </div>
            </div>
        ...
        <script type="text/html" id="tmpl-customize-control-repeater-inner">
            <div class="zoo-repeater-inner">
                ...
                <div class="zoo-repeater-actions">
                    <a href="#" class="zoo-repeater-reorder" data-text="<?php esc_attr_e( 'Reorder', 'ciao' ); ?>" data-done="<?php _e( 'Done', 'ciao' ); ?>"><?php _e( 'Reorder', 'ciao' ); ?></a>
                    <# if ( data.addable ){  #>
                        <button type="button" class="button zoo-repeater-add-new"><?php esc_html_e( 'Add an item', 'ciao' ); ?></button>
                        <# } #>
                </div>
            </div>
        </script>
