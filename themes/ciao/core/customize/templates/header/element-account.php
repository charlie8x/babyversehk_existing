...
$label_text = esc_html__('My account', 'ciao');
        ...
        if (class_exists('WooCommerce', false)) {
            if ($user_logged_in) {
                ...
                <div class="wrap-dashboard-form">
                    ...
                    if($endpoint == 'orders' && in_array( 'vendor', (array) $current_user->roles )){
                        ...
                        echo '<a href="'.esc_url( wc_get_account_endpoint_url( 'points' ) ).'">'.esc_html("Store credit").'</a>';
                        echo '</li>';
                        //echo '</ul>';
                    }
                ?>
            ...
            <div class="wrap-dashboard-form">
                <nav class="woocommerce-MyAccount-navigation">
                    <ul>
                        <li>
                            <a href="<?php echo esc_url($myacc_url) ?>"><?php esc_html_e('My Dashboard', 'ciao') ?></a>
                        </li>
                        ...
                        <?php } ?>
                        <li>
                            <a href="<?php echo esc_url(wp_logout_url(home_url($wp->request))) ?>"><?php esc_html_e('Log Out', 'ciao') ?></a>
                        </li>
                    </ul>
                </nav>
            </div>
                    ...
                    <nav class="woocommerce-MyAccount-navigation">
                        <ul>
                            <li><a href="<?php echo esc_url($login_url) ?>" class="account-login-url"
                                   title="<?php esc_attr_e('Log in', 'ciao') ?>"><?php esc_html_e('Log in', 'ciao') ?></a>
                            </li>
                            <li><a href="<?php echo esc_url($register_url) ?>" class="account-register-url"
                                   title="<?php esc_attr_e('Register', 'ciao') ?>"><?php esc_html_e('Register', 'ciao') ?></a>
                            </li>
                        </ul>
                    </nav>
                </div>
