<?php
/**
 * Zoo_Customize_Builder_Element_Footer_Html2
 *
 ...
 *
 */
final class Zoo_Customize_Builder_Element_Footer_Html2 extends Zoo_Customize_Builder_Element
{
    /**
     * Constructor
     */
    ...
    {
        $this->id = 'footer-html2';
        $this->title = esc_html__('HTML 2', 'ciao');
        $this->width = 6;
        $this->section = 'footer_html2';
    ...
    public function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        ...
        $config = array(
            ...
            array(
                ...
                'theme_supports' => '',
                'default' => esc_html__('Proudly powered by WordPress.', 'ciao'),
                'title' => esc_html__('HTML Code or Shortcodes', 'ciao'),
                'description' => esc_html__('Make sure your code is secure because we can&#8217;t guarantee it will be sanitized properly.', 'ciao'),
            ),
            array(
                ...
                'description' => esc_html__('Styling for html block items', 'ciao'),
                'selector'    => array(
                    'normal'           => "{$selector}",
...
$self->add_element('footer', new Zoo_Customize_Builder_Element_Footer_Html2());
