...
final class Zoo_Customize_Builder_Element_Footer_Copyright extends Zoo_Customize_Builder_Element
{
    ...
    {
        $this->label = esc_html__('Copyright', 'ciao');
    ...
    {
        return array(
            'name'    => esc_html__('Copyright', 'ciao'),
            'id'      => $this->id,
            'col'     => 0,
            'width'   => 6,
    ...
    public function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        ...
        return array(
            ...
            array(
                ...
                'render_callback' => $fn,
                'theme_supports'  => '',
                'default'         => esc_html__('Copyright', 'ciao') . ' &copy; {current_year} {site_title}.',
                'title'           => esc_html__('Copyright Text', 'ciao'),
                'description'     => esc_html__('Arbitrary HTML code or shortcode. Available tags: {current_year}, {site_title}, {theme_author}', 'ciao'),
            ),
            ...
            array(
                ...
                'type'       => 'typography',
                'section'    => $this->section,
                'title'      => esc_html__('Copyright Text Typography', 'ciao'),
    ...
    public function render()
    {
        $tags = array(
            ...
            'theme_author' => sprintf('<a href="zootemplate.com">%1$s</a>', 'ciao'), // Brand name
        );
