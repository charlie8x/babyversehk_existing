<?php
/**
 * Zoo_Customize_Builder_Element_Html5
 *
 ...
 *
 */
final class Zoo_Customize_Builder_Element_Html5 extends Zoo_Customize_Builder_Element
{
    /**
     * Optional construct
     *
    ...
    {
        $this->id = 'html5';
        $this->title = esc_html__('HTML 5', 'ciao');
        $this->width = 4;
        $this->section = 'header_html5';
    ...
    public function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        ...
        $config = array(
            ...
            array(
                ...
                'theme_supports' => '',
                'default' => esc_html__('Add custom text here or remove it', 'ciao'),
                'title' => esc_html__('HTML Code', 'ciao'),
...
$self->add_element('header', new Zoo_Customize_Builder_Element_Html5());
