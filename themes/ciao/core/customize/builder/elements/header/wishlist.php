    ...
    public function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        ...
        $config = [
            ...
            [
                ...
                'default' => esc_html__('My Wishlist', 'ciao'),
            ...
            [
                ...
                'checkbox_label' => esc_html__('Show count of wishlist.', 'ciao'),
                'default' => 0
            ],[
            ...
            [
                ...
                'description' => esc_html__('Advanced styling for icon wishlist', 'ciao'),
                'required' =>['header_wishlist_advanced_styling','==',1],
                'selector' => array(
            ...
            [
                ...
                'description' => esc_html__('Advanced styling for count wishlist', 'ciao'),
                'required' =>['header_wishlist_advanced_styling','==',1],
                'selector' => array(
