<?php
/**
 * Zoo_Customize_Builder_Element_Html4
 *
 ...
 *
 */
final class Zoo_Customize_Builder_Element_Html4 extends Zoo_Customize_Builder_Element
{
    /**
     * Optional construct
     *
    ...
    {
        $this->id = 'html4';
        $this->title = esc_html__('HTML 4', 'ciao');
        $this->width = 4;
        $this->section = 'header_html4';
...
$self->add_element('header', new Zoo_Customize_Builder_Element_Html4());
