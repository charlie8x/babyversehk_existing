...
final class Zoo_Customize_Builder_Element_Logo extends Zoo_Customize_Builder_Element
{
    ...
    {
        $this->id = 'logo';
        $this->title = esc_html__('Site Identity', 'ciao');
        $this->width = 3;
    ...
    function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        $config = [
            [
                ...
                'default' => [],
                'max' => 400,
                'title' => esc_html__('Logo Max Height', 'ciao'),
            ...
            [
                ...
                'title' => esc_html__('Show Site Title', 'ciao'),
                'default' => 'yes',
                'choices' => [
                    'no' => esc_html__('No', 'ciao'),
                    'yes' => esc_html__('Yes', 'ciao'),
                ],
            ...
            [
                ...
                'type' => 'color',
                'section' => $this->section,
                'title' => esc_html__('Site Title Color', 'ciao'),
            ...
            [
                ...
                'section' => $this->section,
                'selector' => $this->selector,
                'title' => esc_html__('Show Site Tagline', 'ciao'),
                'default' => 'no',
                'choices' => [
                    'no' => esc_html__('No', 'ciao'),
                    'yes' => esc_html__('Yes', 'ciao'),
                ...
                'section' => $this->section,
                'selector' => $this->selector,
                'title' => esc_html__('Enable SVG logo', 'ciao'),
                'default' => 'no',
                'choices' => [
                    'no' => esc_html__('No', 'ciao'),
                    'yes' => esc_html__('Yes', 'ciao'),
            ...
            [
                ...
                'type' => 'checkbox',
                'section' => $this->section,
                'label' => esc_html__('Is your SVG code secure?', 'ciao'),
                'description' => esc_html__('Arbitrary code is risky but it&#8217;s up to you.', 'ciao'),
                'checkbox_label' => esc_html__('Yes if checked.', 'ciao'),
            ...
            [
                ...
                'type' => 'textarea',
                'section' => $this->section,
                'title' => esc_html__('Code of SVG logo', 'ciao'),
                'default' => '',
