...
final class Zoo_Customize_Builder_Element_Offcanvas_Menu extends Zoo_Customize_Builder_Element
{
    ...
    {
        $this->id = 'mobile-menu';
        $this->title = esc_html__('Mobile Menu', 'ciao');
        $this->width = 4;
    ...
    function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        ...
        $config = array(
            ...
            array(
                ...
                'max' => 20,
                'checkbox_label' => esc_html__('Arrow icon size', 'ciao'),
            ...
            array(
                ...
                'checkbox_label' => esc_html__('Allow edit style if checked.', 'ciao'),
            ),
            ...
            array(
                ...
                'type' => 'typography',
                'section' => $this->section,
                'title' => esc_html__('Top Menu Items Typography', 'ciao'),
                'description' => esc_html__('Typography for menu', 'ciao'),
                'required'=>['header_mobile_menu_advanced_styling','==',1],
            ...
            array(
                ...
                'description' => esc_html__('Typography for sub menu', 'ciao'),
                'required'=>['header_mobile_menu_advanced_styling','==',1],
