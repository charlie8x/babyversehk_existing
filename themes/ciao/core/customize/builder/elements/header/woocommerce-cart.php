...
final class Zoo_Customize_Builder_Element_Cart extends Zoo_Customize_Builder_Element
{
    ...
    {
        $this->id = 'cart-icon';
        $this->title = esc_html__('WooCommerce Cart', 'ciao');
        $this->width = 4;
    ...
    {
        return [
            'name' => esc_html__('WooCommerce Cart', 'ciao'),
            'id' => 'cart-icon',
            'width' => '3',
            'section' => 'header_cart'
        ];
    ...
    public function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        ...
        $config = [
            [
                ...
                'theme_supports' => '',
                'title' => esc_html__('WooCommerce Cart', 'ciao'),
            ],
            /*General settings*/
            [
            ...
            array(
                ...
                'title' => esc_html__('Cart Icon Style', 'ciao'),
                'choices' => array(
                    'style-1' => esc_html__('Style 1', 'ciao'),
                    ...
                    'style-7' => esc_html__('Style 7', 'ciao'),
                )
            ),
            [
            ...
            [
                ...
                'title' => esc_html__('Show Title', 'ciao'),
            ...
            [
                ...
                'priority' => 3,
                'render_callback' => 'Zoo_Customize_Header_Builder::render',
                'title' => esc_html__('Show Totals', 'ciao'),
                'checkbox_label' => esc_html__('Will be showed if checked.', 'ciao'),
                'device_settings' => true,
                'default' => [
                    'desktop' => 0,
            ...
            [
                ...
                'type' => 'select',
                'section' => $this->section,
                'title' => esc_html__('Display Style', 'ciao'),
                'css_format' => 'html_class',
                'priority' => 4,
                'default' => 'drop-down',
                'choices' => [
                    'drop-down' => esc_html__('Drop down', 'ciao'),
                    'off-canvas' => esc_html__('Off-Canvas Sidebar', 'ciao'),
                    'link-only' => esc_html__('Link Only', 'ciao'),
                ]
            ],
            [
                ...
                'section' => $this->section,
                'priority' => 5,
                'title' => esc_html__('Enable advance styling', 'ciao'),
                'checkbox_label' => esc_html__('Will be showed if checked.', 'ciao'),
                'default' => 0
            ],
            /*Header cart icon*/
            [
                ...
                'section' => $this->section,
                'priority' => 6,
                'title' => esc_html__('Cart Icon Styling', 'ciao'),
            ...
            [
                ...
                'label' => esc_html__('Icon cart Size', 'ciao'),
                'required' => ['header_cart_enable_styling', '==', 1]
            ],
            [
                ...
                'label' => esc_html__('Cart Icon Width', 'ciao'),
                'required' => ['header_cart_enable_styling', '==', 1],
            ],
            [
                ...
                'type' => 'styling',
                'section' => $section,
                'title' => esc_html__('Icon Cart Styling', 'ciao'),
                'description' => esc_html__('Advanced styling for icon cart', 'ciao'),
                'selector' => array(
            ...
            [
                ...
                'section' => $this->section,
                'priority' => 8,
                'title' => esc_html__('Cart Count Styling', 'ciao'),
                'required' => ['header_cart_enable_styling', '==', 1]
            ],
            [
                ...
                'priority' => 9,
                'css_format' => 'html_class',
                'title' => esc_html__('Cart count position', 'ciao'),
                'default' => 'top-right',
                'device_settings' => true,
                'required' => ['header_cart_enable_styling', '==', 1],
                'choices' => [
                    'inside' => esc_html__('Inside cart icon', 'ciao'),
            ...
            [
                ...
                'label' => esc_html__('Cart Count Size', 'ciao'),
                'required' => ['header_cart_enable_styling', '==', 1],
            ], [
                ...
                'label' => esc_html__('Cart Count Width', 'ciao'),
                'required' => ['header_cart_enable_styling', '==', 1],
            ],
            [
                ...
                'section' => $section,
                'title' => esc_html__('Cart Count Styling', 'ciao'),
                'description' => esc_html__('Advanced styling for cart count', 'ciao'),
                'selector' => array(
            ...
            [
                ...
                'section' => $this->section,
                'priority' => 12,
                'title' => esc_html__('Cart Title Settings', 'ciao'),
                'required' => ['header_cart_enable_styling', '==', 1],
            ],
            [
            ...
            [
                ...
                'section' => $this->section,
                'priority' => 15,
                'title' => esc_html__('Cart Totals Settings', 'ciao'),
                'required' => ['header_cart_enable_styling', '==', 1],
                'device_settings' => true,
            ],
            [
