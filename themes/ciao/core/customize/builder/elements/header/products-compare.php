...
final class Zoo_Customize_Builder_Element_Products_Compare extends Zoo_Customize_Builder_Element
{
    ...
    {
        return [
            'name'    => esc_html__('Products Compare', 'ciao'),
            'id'      => $this->id,
            'width'   => '2',
    ...
    public function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        ...
        $config = [
            ...
            [
                ...
                'default' => esc_html__('My compare', 'ciao')
            ],
            [
            ...
            [
                ...
                'selector' => $this->selector,
                'render_callback' => [$this, 'render'],
                'title' => esc_html__('Show count', 'ciao'),
                'checkbox_label' => esc_html__('Show count of compare.', 'ciao'),
                'default' => 0
            ],[
            ...
            [
                ...
                'description' => esc_html__('Advanced styling for icon compare', 'ciao'),
                'required'=>['header_compare_advanced_styling','==',1],
                'selector' => array(
                ...
                'type' => 'heading',
                'section' => $this->section,
                'title' => esc_html__('Style Count Settings', 'ciao'),
                'required'=>['header_compare_advanced_styling','==',1]
            ],
            [
                ...
                'title' => esc_html__('Count position', 'ciao'),
                'default' => 'top-right',
                'required'=>['header_compare_advanced_styling','==',1],
                'choices' => [
                    'inside' => esc_html__('Inside icon', 'ciao'),
            ...
            [
                ...
                'label' => esc_html__('Count Size', 'ciao'),
                'required'=>['header_compare_advanced_styling','==',1]
            ],[
                ...
                'label' => esc_html__('Count Width', 'ciao'),
                'required'=>['header_compare_advanced_styling','==',1]
            ],
            [
                ...
                'type' => 'styling',
                'section' => $this->section,
                'title' => esc_html__('Count Styling', 'ciao'),
                'description' => esc_html__('Advanced styling for count compare', 'ciao'),
                'required'=>['header_compare_advanced_styling','==',1],
                'selector' => array(
