...
final class Zoo_Customize_Builder_Element_Button extends Zoo_Customize_Builder_Element
{
    ...
    {
        $this->id = 'button';
        $this->title = esc_html__('Button', 'ciao');
        $this->width = 4;
    ...
    public function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        ...
        $config = array(
            ...
            array(
                ...
                'selector' => $selector,
                'render_callback' => $fn,
                'title' => esc_html__('Text', 'ciao'),
                'default' => esc_html__('Button', 'ciao'),
            ...
            array(
                ...
                'type' => 'typography',
                'section' => $section,
                'title' => esc_html__('Typography', 'ciao'),
                'description' => esc_html__('Advanced typography for button', 'ciao'),
                'selector' => $selector,
            ...
            array(
                ...
                'section' => $section,
                'title' => esc_html__('Styling', 'ciao'),
                'description' => esc_html__('Advanced styling for button', 'ciao'),
                'selector' => array(
                    'normal' => $selector,
