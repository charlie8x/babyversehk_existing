...
add_filter('zoo/customizer/config', function(array $configs = [])
{
    $config = [
        [
            ...
            'title' => esc_html__('Header Sticky', 'ciao'),
        ],
        [
            ...
            'title' => esc_html__('Absolute Header', 'ciao'),
            'checkbox_label' => esc_html__('If checked, header will overlap content. Helpful for transparent headers.', 'ciao')
        ],
        [
            ...
            'section' => 'header_sticky',
            'render_callback' => 'Zoo_Customize_Header_Builder::render',
            'title' => esc_html__('Enable Header Top Sticky', 'ciao'),
        ...
        [
            ...
            'section' => 'header_sticky',
            'render_callback' => 'Zoo_Customize_Header_Builder::render',
            'title' => esc_html__('Enable Header Main Sticky', 'ciao'),
            'checkbox_label' => esc_html__('Will be enabled if checked.', 'ciao'),
            'device_settings' => true,
            'default' => [
                'desktop' => 0,
        ...
        [
            ...
            'section' => 'header_sticky',
            'render_callback' => 'Zoo_Customize_Header_Builder::render',
            'title' => esc_html__('Enable Header Bottom Sticky', 'ciao'),
            'checkbox_label' => esc_html__('Will be enabled if checked.', 'ciao'),
            'device_settings' => true,
            'default' => [
                'desktop' => 0,
        ...
        [
            ...
            'max'     => 100,
            'device_settings' => true,
            'title' => esc_html__('Max Header Top Sticky Height', 'ciao'),
        ...
        [
            ...
            'max'     => 400,
            'device_settings' => true,
            'title' => esc_html__('Max Header Main Sticky Height', 'ciao'),
        ...
        [
            ...
            'max'     => 100,
            'device_settings' => true,
            'title' => esc_html__('Max Header Bottom Sticky Height', 'ciao'),
        ...
        [
            ...
            'type'            => 'select',
            'section'         => 'header_sticky',
            'title'           => esc_html__('Sticky Animation', 'ciao'),
            'selector'        => '.site-header .is-sticky',
            'css_format'      => 'html_class',
            'default'         => 'none',
            'choices'         => [
                'none' => esc_html__('None', 'ciao'),
                'jump-down' => esc_html__('Jump Down', 'ciao')
            ]
        ],
        [
            ...
            'render_callback' => 'Zoo_Customize_Header_Builder::render',
            'title' => esc_html__('Custom Sticky Logo', 'ciao')
        ],
        [
            ...
            'max'     => 100,
            'device_settings' => true,
            'title' => esc_html__('Max Height of Logo Sticky', 'ciao'),
        ...
        [
            ...
            'type' => 'styling',
            'section' => 'header_sticky',
            'title' => esc_html__('Sticky Styling', 'ciao'),
