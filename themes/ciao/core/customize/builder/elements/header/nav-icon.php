...
final class Zoo_Builder_Element_Nav_Icon extends Zoo_Customize_Builder_Element
{
    ...
    {
        return array(
            'name' => esc_html__('Menu Icon', 'ciao'),
            'id' => $this->id,
            'width' => '3',
    ...
    public function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        ...
        $config = array(
            array(
                ...
                'theme_supports' => '',
                'title' => esc_html__('Menu Icon', 'ciao'),
            ),
            array(
                ...
                'title' => esc_html__('Nav Icon Style', 'ciao'),
                'choices' => array(
                    'menu' => esc_html__('Menu', 'ciao'),
                    'dots' => esc_html__('Dots', 'ciao'),
                    'filter' => esc_html__('Filter', 'ciao'),
                )
            ),
            array(
            ...
            array(
                ...
                'selector' => $selector,
                'render_callback' => $fn,
                'title' => esc_html__('Label Settings', 'ciao'),
                'device_settings' => true,
                'default' => array(
                    'desktop' => 1,
                    'mobile' => 0,
                ),
                'checkbox_label' => esc_html__('Show Label', 'ciao'),
            ),
            ...
            array(
                ...
                'label' => esc_html__('Label Size', 'ciao'),
            ),
