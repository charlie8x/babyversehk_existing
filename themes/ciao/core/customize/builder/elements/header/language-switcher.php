...
final class Zoo_Customize_Builder_Element_Language_Switcher extends Zoo_Customize_Builder_Element
{
    ...
    public function __construct()
    {
        ...
        $this->title   = esc_html__('Language Switcher', 'ciao');
        $this->width   = 3;
    ...
    public function get_customize_configs(WP_Customize_Manager $wp_customize = null)
    {
        ...
        $config= [
			[
				...
				'title' => esc_html__('Language Switcher', 'ciao'),
			],
			[
				...
				'title'           => esc_html__('Label', 'ciao'),
				'default'         => esc_html__('Languages', 'ciao'),
			],
			[
			...
			[
				...
				'render_callback' => [$this, 'render'],
				'default'         => 'before',
				'title'           => esc_html__('Icon Position', 'ciao'),
				'choices'         => [
					'before' => esc_html__('Before', 'ciao'),
					'after'  => esc_html__('After', 'ciao'),
				]
			],
            [
            ...
            array(
                ...
                'section'     => $this->section,
                'title'       => esc_html__('Styling', 'ciao'),
                'description' => esc_html__('Styling for language switcher', 'ciao'),
            ...
            array(
                ...
                'type'        => 'styling',
                'section'     => $this->section,
                'title'       => esc_html__('List Languages Styling', 'ciao'),
                'description' => esc_html__('Styling for list language switcher', 'ciao'),
                'required'=>['header_language_switcher_advanced_styling','==',1],
                'selector'    => array(
