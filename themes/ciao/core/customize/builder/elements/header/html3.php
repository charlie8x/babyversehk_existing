<?php
/**
 * Zoo_Customize_Builder_Element_Html3
 *
 ...
 *
 */
final class Zoo_Customize_Builder_Element_Html3 extends Zoo_Customize_Builder_Element
{
    /**
     * Optional construct
     *
    ...
    {
        $this->id = 'html3';
        $this->title = esc_html__('HTML 3', 'ciao');
        $this->width = 4;
        $this->section = 'header_html3';
...
$self->add_element('header', new Zoo_Customize_Builder_Element_Html3());
