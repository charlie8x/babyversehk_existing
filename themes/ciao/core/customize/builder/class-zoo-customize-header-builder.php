...
class Zoo_Customize_Header_Builder extends Zoo_Customize_Builder_Block
{
    ...
    function get_config()
    {
        return [
            ...
            'devices' => [
                'desktop' => esc_html__('Desktop', 'ciao'),
                'mobile' => esc_html__('Mobile/Tablet', 'ciao'),
            ],
        ];
    }
    ...
    {
        return [
            'top' => esc_html__('Header Top', 'ciao'),
            'main' => esc_html__('Header Main', 'ciao'),
            'bottom' => esc_html__('Header Bottom', 'ciao'),
            'sidebar' => esc_html__('Off Canvas Sidebar', 'ciao'),
        ];
    }
    ...
    function row_config($section = false, $section_name = false)
    {
        ...
        return [
            ...
            [
                ...
                'max' => 100,
                'device_settings' => true,
                'title' => esc_html__('Font Size', 'ciao'),
                'selector'        => "{$selector}",
    ...
    function row_sidebar_config($section, $section_name)
    {
        ...
        $selector = '.wrap-header-off-canvas';
        ...
        $config = array(
            ...
            array(
                ...
                'render_callback' => 'Zoo_Customize_Header_Builder::render',
                'css_format' => 'html_class',
                'title' => esc_html__('Animation', 'ciao'),
                'default' => 'off-canvas-slide-left',
                'device_settings' => true,
                'choices' => array(
                    'off-canvas-slide-left' => esc_html__('Slide From Left', 'ciao'),
                    'off-canvas-slide-right' => esc_html__('Slide From Right', 'ciao'),
                    'off-canvas-full-screen' => esc_html__('Full-screen Overlay', 'ciao'),
                    'off-canvas-dropdown' => esc_html__('Toggle Dropdown', 'ciao'),
                )
            ),
            ...
            array(
                ...
                'css_format' => 'html_class',
                'title' => esc_html__('Text Mode Color', 'ciao'),
