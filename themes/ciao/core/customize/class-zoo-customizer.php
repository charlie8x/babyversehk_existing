...
final class Zoo_Customizer
{
    ...
    private function __construct()
    {
        $this->panels = apply_filters('zoo_default_customize_panels', [
            'header_settings' => [
                'title'    => esc_html__('Site Header', 'ciao'),
                'priority' => -999
            ],
            'layout_panel' => [
                'title'    => esc_html__('Layouts', 'ciao'),
                'priority' => 19
            ],
            'footer_settings' => [
                'title'    => esc_html__('Site Footer', 'ciao'),
                'priority' => 999
            ]
        ]);
        ...
        $this->sections = apply_filters('zoo_default_customize_sections', [
            'header_builder_panel' => [
                'title' => esc_html__('Header Builder', 'ciao'),
                'panel' => 'header_settings',
            ],
            'global_layout_section' => [
                'title' => esc_html__('Global', 'ciao'),
                'panel' => 'layout_panel',
            ],
            'sidebar_layout_section' => [
                'panel' => 'layout_panel',
                'title' => esc_html__('Sidebars', 'ciao')
            ],
            'footer_general' => [
    ...
    function _ajax_load_fonts()
    {
        $fonts = [
            'normal' => [
                'title' => esc_html__('Default Web Fonts', 'ciao'),
                'fonts' => zoo_get_websafe_fonts()
            ],
            'google' => [
                'title' => esc_html__('Google Web Fonts', 'ciao'),
    ...
    public function _ajax_load_font_icons()
    {
        ...
        $fonts = [
            'zoo-icon' => [
                'name'  => esc_html__('Theme Icon', 'ciao'),
        ...
        if (current_theme_supports('cs-font')) {
            $fonts['cs-font'] = [
                'name'  => esc_html__('Clever Font', 'ciao'),
    ...
    public function _load_controls_assets()
    {
        ...
        wp_localize_script('zoo-customize', 'ZooCustomizeBuilderData', [
            ...
            'is_rtl'           => is_rtl(),
            'theme_default'    => esc_html__('Theme Default', 'ciao'),
            'reset'            => esc_html__('Reset this section settings', 'ciao'),
            'untitled'         => esc_html__('Untitled', 'ciao'),
            'confirm_reset'    => esc_html__('Do you want to reset this section settings?', 'ciao'),
            'typo_fields'      => $this->get_typo_fields(),
            'styling_config'   => $this->get_styling_config(),
            'devices'          => self::SUPPORT_DEVICES,
            'list_font_weight' => [
                ''       => esc_html__('Default', 'ciao'),
                'normal' => _x('Normal', 'zoo-font-weight', 'ciao'),
                'bold'   => _x('Bold', 'zoo-font-weight', 'ciao')
            ],
    ...
    public function get_typo_fields()
    {
        $typo_fields = array(
            array(
                'name'    => 'font',
                'type'    => 'select',
                'label'   => esc_html__('Font Family', 'ciao'),
                'choices' => array()
            ),
            array(
                'name'    => 'font_weight',
                'type'    => 'select',
                'label'   => esc_html__('Font Weight', 'ciao'),
                'choices' => array()
            ),
            array(
                'name'  => 'languages',
                'type'  => 'checkboxes',
                'label' => esc_html__('Font Languages', 'ciao'),
            ),
            array(
                'name'            => 'font_size',
                'type'            => 'slider',
            ...
            array(
                'name'            => 'line_height',
                'type'            => 'slider',
                'label'           => esc_html__('Line Height', 'ciao'),
                'min'             => 9,
                'max'             => 80,
                'step'            => 1
            ),
            array(
                'name'  => 'letter_spacing',
                'type'  => 'slider',
                'label' => esc_html__('Letter Spacing', 'ciao'),
                'min'   => -10,
                'max'   => 10,
                'step'  => 0.1
            ),
            array(
                'name'    => 'style',
                'type'    => 'select',
                'label'   => esc_html__('Font Style', 'ciao'),
                'choices' => array(
                    ''        => esc_html__('Default', 'ciao'),
                    'normal'  => esc_html__('Normal', 'ciao'),
                    'italic'  => esc_html__('Italic', 'ciao'),
                    'oblique' => esc_html__('Oblique', 'ciao'),
                )
            ),
            array(
                'name'    => 'text_decoration',
                'type'    => 'select',
                'label'   => esc_html__('Text Decoration', 'ciao'),
                'choices' => array(
                    ''             => esc_html__('Default', 'ciao'),
                    'underline'    => esc_html__('Underline', 'ciao'),
                    'overline'     => esc_html__('Overline', 'ciao'),
                    'line-through' => esc_html__('Line through', 'ciao'),
            ...
            array(
                'name'    => 'text_transform',
                'type'    => 'select',
                'label'   => esc_html__('Text Transform', 'ciao'),
                'choices' => array(
                    ''           => esc_html__('Default', 'ciao'),
                    'uppercase'  => esc_html__('Uppercase', 'ciao'),
                    'lowercase'  => esc_html__('Lowercase', 'ciao'),
                    'capitalize' => esc_html__('Capitalize', 'ciao'),
                    'none'       => esc_html__('None', 'ciao'),
                )
            )
        );
    ...
    public function get_styling_config()
    {
        $fields = array(
            'tabs'          => array(
                'normal' => esc_html__('Normal', 'ciao'),  // null or false to disable
                'hover'  => esc_html__('Hover', 'ciao'), // null or false to disable
            ),
            'normal_fields' => array(
                array(
                    'name'       => 'text_color',
                ...
                array(
                    ...
                    'type'       => 'color',
                    'device_settings' => true,
                    'label'      => esc_html__('Link Color', 'ciao'),
                    'css_format' => 'color: {{value}}; text-decoration-color: {{value}};'
                ),
                array(
                    ...
                    'type'       => 'color',
                    'device_settings' => true,
                    'label'      => esc_html__('Link Hover Color', 'ciao'),
                    'css_format' => 'color: {{value}}; text-decoration-color: {{value}};'
                ),
                ...
                array(
                    'name'  => 'bg_heading',
                    'type'  => 'heading',
                    'label' => esc_html__('Background', 'ciao'),
                ),
                ...
                array(
                    ...
                    'type'       => 'image',
                    'device_settings' => true,
                    'label'      => esc_html__('Background Image', 'ciao'),
                ...
                array(
                    ...
                    'choices'    => array(
                        ''        => esc_html__('Default', 'ciao'),
                        'auto'    => esc_html__('Auto', 'ciao'),
                        'cover'   => esc_html__('Cover', 'ciao'),
                        'contain' => esc_html__('Contain', 'ciao'),
                    ),
                ...
                array(
                    ...
                    'type'       => 'select',
                    'device_settings' => true,
                    'label'      => esc_html__('Position', 'ciao'),
                    'required'   => array('bg_image', 'not_empty', ''),
                    'class'      => 'field-half-right',
                    'choices'    => array(
                        ''              => esc_html__('Default', 'ciao'),
                        'center'        => esc_html__('Center', 'ciao'),
                        'top left'      => esc_html__('Top Left', 'ciao'),
                        'top right'     => esc_html__('Top Right', 'ciao'),
                        'top center'    => esc_html__('Top Center', 'ciao'),
                        'bottom left'   => esc_html__('Bottom Left', 'ciao'),
                        'bottom center' => esc_html__('Bottom Center', 'ciao'),
                        'bottom right'  => esc_html__('Bottom Right', 'ciao'),
                    ),
                ...
                array(
                    ...
                    'type'       => 'select',
                    'device_settings' => true,
                    'label'      => esc_html__('Repeat', 'ciao'),
                    'class'      => 'field-half-left',
                    'required'   => array(
                        array('bg_image', 'not_empty', ''),
                    ),
                    'choices'    => array(
                        'repeat'    => esc_html__('Default', 'ciao'),
                        'no-repeat' => esc_html__('No repeat', 'ciao'),
                        'repeat-x'  => esc_html__('Repeat horizontal', 'ciao'),
                        'repeat-y'  => esc_html__('Repeat vertical', 'ciao'),
                    ),
                ...
                array(
                    ...
                    'type'       => 'select',
                    'device_settings' => true,
                    'label'      => esc_html__('Attachment', 'ciao'),
                    'class'      => 'field-half-right',
                    'required'   => array(
                        array('bg_image', 'not_empty', '')
                    ),
                    'choices'    => array(
                        ''       => esc_html__('Default', 'ciao'),
                        'scroll' => esc_html__('Scroll', 'ciao'),
                        'fixed'  => esc_html__('Fixed', 'ciao')
                    ),
                ...
                array(
                    ...
                    'type'       => 'shadow',
                    'device_settings' => true,
                    'label'      => esc_html__('Box Shadow', 'ciao'),
