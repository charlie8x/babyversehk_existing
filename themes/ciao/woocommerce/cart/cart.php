    ...
    <div class="wrap-cart-table">
        ...
        <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
            ...
            <tr>
                ...
                <th class="product-price"><?php esc_html_e('Price (HKD)', 'woocommerce'); ?></th>
                    ...
                    <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                        <td class="product-thumbnail">
							...
							if (!$product_permalink) {
								echo ent2ncr($thumbnail); // PHPCS: XSS ok.
							} else {
        ...
        <div class="bottom-table-cart">
			...
			<?php } ?>
            <a class="button btn back-shop" title="<?php echo esc_attr__('Continue Shopping', 'woocommerce') ?>"
