 ...
 * @author aatanasov
 */
class BabystreetContactsWidget extends WP_Widget {

	public function __construct() {
		$widget_ops = array('description' => esc_html__('Shows contact details', 'babystreet-plugin'));
		parent::__construct('babystreet_contacts_widget', 'Babystreet Contacts details', $widget_ops);
	}
	...
	public function form($instance) {
		// Defaults
		$defaults = array(
				'title' => esc_html__('Have a Question?', 'babystreet-plugin'),
				'worktime' => '',
				'address' => '',
				'phone' => '',
				'fax' => '',
		...
		?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'babystreet-plugin'); ?></label>
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email address:', 'babystreet-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone number:', 'babystreet-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('worktime')); ?>"><?php esc_html_e('Store working time:', 'babystreet-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Address:', 'babystreet-plugin'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('fax')); ?>"><?php esc_html_e('Fax number:', 'babystreet-plugin'); ?></label>
...
add_action('widgets_init', 'babystreet_register_babystreet_contacts_widget');
if (!function_exists('babystreet_register_babystreet_contacts_widget')) {

	function babystreet_register_babystreet_contacts_widget() {
		register_widget('BabystreetContactsWidget');
	}
