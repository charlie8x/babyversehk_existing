...
jQuery('.custom-effect .babystreet-image-icon .icon_wrapper .icon_inner').addClass('wow fadeInDown');
jQuery('.custom-effect .babystreet-image-icon .iconbox_content').addClass('wow fadeInDown');
