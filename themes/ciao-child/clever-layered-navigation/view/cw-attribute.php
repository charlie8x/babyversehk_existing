...
if(class_exists( 'Zoo_Clever_Swatch_Helper' )) {
    ...
    if (isset($content_data['display-style'])) {
        if (($cw_display_type == 'image') && $content_data['display-style'] == 'inline') {
    ...
    if (count($terms) > 0) {
        ...
        ?>
        <div id="cln-filter-item-<?php echo esc_attr($filter_id) ?>"
            ...
            <ul class="zoo-list-cw-attribute <?php if ($cw_display_type == 'select' || $display_style == 'list') {
                ...
                foreach ($terms as $term) {
                    ...
                    if ($cw_display_type == 'color') {
                        ...
                        $html .= '<span class="cw-type swatch-type-color ' . $term->slug . '" style="background:' . $color . '">';
