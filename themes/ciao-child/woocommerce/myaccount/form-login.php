...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="u-column2 col-2" <?php if($action=='register'){?>style="display:block" <?php }?>>
		...
		<h2><?php esc_html_e( 'sign up', 'anon' ); ?></h2>
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<p class="woocommerce-form-row form-row">
				...
				<button type="submit" class="woocommerce-Button button" name="register" value="<?php esc_attr_e( 'Register', 'anon' ); ?>"><?php esc_html_e( 'Sign up', 'anon' ); ?></button>
			</p>

			<?php do_action( 'woocommerce_register_form_end' ); ?>
			<p class="sell-withus-left">Want to Sell With Us?<br><a href="https://babyverse.com.hk/sell-with-us/#Schedule-a-collection">Click here</a> for a FREE pickup and become a seller</p>
		</form>
    ...
    <div class="wrap-toggle-form-block">
        <div class="toggle-form-block-login" <?php if($action=='register'){?>style="display:block" <?php }?>>
            ...
            <div class="content-toggle-block">
                <p><?php esc_html_e('Already have an account? Login here','anon')?></p>
        ...
        <div class="toggle-form-block-register" <?php if($action=='register'){?>style="display:none" <?php }?>>
            <h2><?php esc_html_e('sign up','anon')?></h2>
            <div class="content-toggle-block">
                <p><?php esc_html_e('Register now and shop discounted pre-loved and past season luxury.','anon')?></p>
                <span class="button toggle-form-button toggle-register"><?php esc_html_e('sign up','anon')?></span></br>
				  <p>Want to Sell With Us?<br><a href="https://babyverse.hk/sell-with-us/#Schedule-a-collection">Click here</a> for a FREE pickup and become a seller</p>
            </div>
        </div>
    </div>
<?php endif; ?>
